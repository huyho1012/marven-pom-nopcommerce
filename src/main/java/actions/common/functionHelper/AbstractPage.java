...
public abstract class AbstractPage {
    ...
    public void uploadMultipleFiles(WebDriver driver, String... fileNames){
        ...
        for(String file: fileNames){
            fullFileName = fullFileName+ Constants.ROOT_UPLOAD_FILE+ file+ "\n";
        }
    ...
    // Default Dropdown
    public void selectItemOnDropdown(WebDriver driver, String locator, String itemValue, String...values){
